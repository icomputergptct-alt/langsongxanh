...
export const SoftwareUtilities: React.FC<SoftwareUtilitiesProps> = ({
  ...
  const [fmtInput, setFmtInput] = useState(`{"platform":"Long Hoà Số","version":2026,"capabilities":{"deepAnalysis":true,"offlineVault":true,"examRoom":true,"geminiAI":true},"tags":["AI","Security","Cloud"]}`);
  ...
  const [encInput, setEncInput] = useState('Long Hoà Số Nền tảng Tri thức Công nghệ Số 2026');
