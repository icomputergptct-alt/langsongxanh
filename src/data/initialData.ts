...
export const SOFTWARE_UTILITIES: SoftwareUtility[] = [
  ...
  },
  {
    ...
    category: 'Bảo mật & Mã hoá',
    icon: 'KeyRound',
    shortDesc: 'Tạo mật khẩu ngẫu nhiên độ an toàn cao, API secret key, UUID v4 và đánh giá độ mạnh Entropy thời gian thực.',
    detailedDesc: 'Sử dụng bộ sinh số ngẫu nhiên mật mã (Web Crypto API CSPRNG) đảm bảo mật khẩu và token không thể đoán trước, phòng chống tấn công brute-force và từ điển.',
    badge: 'Bảo mật cao',
    features: [
      'Sinh mật khẩu tùy biến: chữ hoa, chữ thường, số, ký tự đặc biệt',
      'Sinh chuỗi Hex, Base64 Token, UUID v4 ngẫu nhiên',
      'Thước đo đánh giá độ mạnh mật khẩu (Password Entropy & Bit Strength)',
      '100% xử lý cục bộ trên trình duyệt, không gửi dữ liệu qua mạng'
    ],
    useCases: [
      'Tạo Secret Key an toàn cho JWT, Webhook, API Gateway',
      'Tạo mật khẩu quản trị cơ sở dữ liệu và máy chủ Linux',
      'Tạo chuỗi salt và random token xác thực người dùng'
    ],
    guides: [
      {
        step: 1,
        title: 'Thiết lập độ dài và bộ ký tự',
        instruction: 'Kéo thanh trượt để chọn độ dài (khuyến nghị từ 16 ký tự trở lên) và tích chọn các nhóm ký tự mong muốn.'
      },
      {
        step: 2,
        title: 'Tạo và kiểm tra điểm Entropy',
        instruction: 'Nhấn nút "Tạo mới". Quan sát thanh đo an toàn (Rất mạnh > 90 bits).'
      },
      {
        step: 3,
        title: 'Sao chép an toàn',
        instruction: 'Nhấn nút sao chép. Khuyến khích lưu trữ mật khẩu trong Password Manager chuyên dụng.'
      }
    ]
  },
  {
